                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h3 className="font-semibold text-lg dark:text-white">{category.categoryName}</h3>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-2 dark:text-gray-300">Tienda</label>
              <select className="glass-input w-full dark:bg-gray-800 dark:text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <label htmlFor="urgent" className="text-sm font-medium dark:text-gray-300">
              Marcar como urgente
            </label>
          </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <GlassCard variant="subtle" className="p-4 text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Presupuesto Total</p>
            </GlassCard>
            <GlassCard variant="subtle" className="p-4 text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Ahorro Estimado</p>
            </GlassCard>
          </div>

          <div>
            <h3 className="font-semibold mb-3 dark:text-white">Distribución por Categoría</h3>
                  ...
                  <div key={category.id} className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between text-sm mb-1">
                        <span className="dark:text-gray-300">{category.categoryName}</span>
                        <span className="font-medium dark:text-white">${categoryTotal.toFixed(2)}</span>
                      </div>
          ...
          <GlassCard variant="subtle" className="p-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="font-semibold dark:text-white">Consejos de Ahorro</h3>
            </div>
